...
- selecao.py:     df_selecionavel        — UI pura, sem acesso a dado.
...
"""
from components.widgets.selecao import df_selecionavel
...
__all__ = ["df_selecionavel", "make_widget_comentario", "make_toolbar_export"]
